...
if __name__ == "__main__":
    folder = "/home/julpe/Documents/DATA/Singleorb-DATA/juraj_oneband/LDGA_Nk2304_Nq2304_wc60_vc40_vs20/Eliashberg"
    f_ud_loc_pp = np.load(f"{folder}/f_ud_loc_pp.npy")[0, 0, 0, 0]
