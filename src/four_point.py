...
from i_am_nonlocal import IAmNonLocal
...
class FourPoint(LocalFourPoint, IAmNonLocal):
    ...
    def to_compound_indices(self) -> "FourPoint":
        ...
        if self.num_bosonic_frequency_dimensions == 0:
            raise ValueError("Cannot convert to compound indices if there is no w dimension.")
        elif self.num_q_dimensions == 0:
        ...
        if self.num_q_dimensions == 1 and self.num_bosonic_frequency_dimensions == 1:  # [q, o1, o2, o3, o4, w, ...]
            ...
            if self.num_k_dimensions == 0:
                ...
                elif self.num_fermionic_frequency_dimensions == 2:  # [q, o1, o2, o3, o4, w, v, vp]
            ...
            if self.num_k_dimensions == 2:
                ...
                elif self.num_fermionic_frequency_dimensions == 2:  # [q, k, k', o1, o2, o3, o4, w, v, vp]
    ...
    def permute_orbitals(self, permutation: str = "ijkl->ijkl") -> "FourPoint":
        """
    ...
    def reduce_to_one_dimensional_k_space(self) -> "FourPoint":
        ...
        self.mat = np.diagonal(self.mat, axis1=1, axis2=2)
